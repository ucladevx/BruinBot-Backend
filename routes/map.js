 ...
 * Get all paths.
 */
mapRouter.route('/paths').get(async (req, res) => {
	try {
 ...
 */
mapRouter.route('/paths').post(async (req, res) => {
 ...
 */
mapRouter.route('/paths').delete(async (req, res) => {
...
/**
 * Delete map node and any of its paths by id.
 */
